    ...
    <div className="relative p-5 bg-white dark:bg-[#1a1a1a] rounded-xl border border-gray-200 dark:border-gray-800 mb-6 shadow-sm">
      <div className="flex items-center gap-4">
        ...
        <div className="min-w-0">
          ...
          <a href={`mailto:${email}`} className="text-xs text-gray-500 dark:text-gray-400 hover:underline break-all">{email}</a>
        </div>
      </div>
      ...
      <div className="mt-4">
        <Link
          ...
          className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-md border border-gray-200 dark:border-gray-800 text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
          target="_blank"
